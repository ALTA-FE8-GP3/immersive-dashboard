    ...
    <div>
      <div className='px-3'>
        ...
        <Row className="d-xl-flex justify-content-center mt-4 ">
          ...
          {[{ icon: iconCheck, text: "Joined Class", style: checkStyle }, { icon: iconRepeat, text: "Repeated Unit", style: repeatStyle }, { icon: iconX, text: "Eliminated", style: xStyle }].map((item, index) => {
